...
//        $this->baseURL = $this->baseURL.$query_string_sep;
        ...
        $this->currentPage = isset($this->offset) ? $this->offset:0;
//        echo $this->currentPage;die;
        ...
        if ($this->showCount){
           ...
           $info = '<br>Showing ' . $currentOffset . ' to ' ;
...
//                    $output .= $this->curTagOpen.$loop.$this->curTagClose;
                    ...
                    $output .= $this->numTagOpen.'<a class="active" href="'.$this->baseURL.$i.'">'.$loop.'</a>'.$this->numTagClose;
                }else{
        ...
        $output = $this->fullTagOpen.$output.$this->fullTagClose.$notification;
