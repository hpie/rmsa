...
<div class="col-md-9 col-sm-9">
    <div class="middle-area">
        <h1 class="heading">Update Teacher Profile</h1>

        <form method="post" id="frm_general_info" class="form-horizontal border p-2" action="<?php echo RMSA_TEACGER_UPDATE_PROFILE_LINK.$student_data['rmsa_user_id']; ?>">
