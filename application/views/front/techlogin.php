...
<div class="col-md-9 col-sm-9">
    <div class="middle-area">
        <h1 class="heading">RMSA: &nbsp;Teacher Login Screen</h1>
        <form class="form-horizontal border p-2" method="post" action="<?php echo TEACHER_LOGIN_LINK ?>">
            ...
            <div class="form-group">
                <div class="row">
                   <script nonce='S51U26wMQz' src="https://www.google.com/recaptcha/api.js" async defer></script>
                    <script nonce='S51U26wMQz' >function enableLogin() { document.getElementById("btnLogin").disabled = false; }</script>
