...
<div class="col-md-6 col-sm-8  col-12">
    <div class="middle-area">
        ...
        <form method="post" class="form-horizontal border p-2" action="<?php echo BASE_URL?>/front/StudentLogin/process">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input id="student_username" name="student_username" type="text" class="form-control" placeholder="User Name">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input id="student_password" name="student_password" type="password" class="form-control" placeholder="">
                    </div>
                </div>
            </div>
