...
<div class="col-md-9 col-sm-9">
    <div class="middle-area">
        ...
        <form method="post" id="create_quiz" class="form-horizontal border p-2" action="<?php echo EMPLOYEE_ADD_QUISTIONS_LINK.$quiz_id; ?>">
            <h2 class="second-heading">Question Information</h2>            
            <div class="form-group">
                <div class="row">
                    <label class="control-label col-sm-4 col-xs-12" for="question">Question:</label>
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" name="question" id="question" placeholder="Qusetion text" required="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" name="choice[]" id="choice1" placeholder="" required="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" name="choice[]" id="choice2" placeholder="" required="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" name="choice[]" id="choice3" placeholder="" required="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" name="choice[]" id="choice4" placeholder="" required="">
                    </div>
                </div>
            </div>
            <div class="form-group">
