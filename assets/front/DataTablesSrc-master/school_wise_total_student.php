...
// indexes
$columns = array(
    array('db' => 'rmsa_school_id', 'dt' =>'rmsa_school_id'),
     array('db' => 'rmsa_school_title', 'dt' => 'rmsa_school_title')
);
include 'conn.php';
...
echo json_encode(
    SSP::rmsa_school_wise_count_student($_REQUEST, $sql_details, $table, $primaryKey, $columns)
);
