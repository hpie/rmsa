...
$columns = array(
    ...
    array('db' => 'reu.rmsa_user_email_verified_status', 'dt' =>'rmsa_user_email_verified_status')
);
...
echo json_encode(
    SSP::rmsa_teachers_list($_REQUEST, $sql_details, $table, $primaryKey, $columns)
);
