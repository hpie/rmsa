...
// indexes
$columns = array(
    array('db' => 'rmsa_block_id', 'dt' =>'rmsa_block_id'),
     array('db' => 'rmsa_block_name', 'dt' => 'rmsa_block_name')
);
include 'conn.php';
...
echo json_encode(
    SSP::rmsa_block_wise_count_student($_REQUEST, $sql_details, $table, $primaryKey, $columns)
);
